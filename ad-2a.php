...
<header>
					...
					<div class="todoBloc">
						...
						<div class="blocList">
							...
							<div class="partListe"><i id="downloadIcon" class="fas fa-cloud-download-alt"></i>Télécharger le questionnaire AD 2A<a href="questionnaire_ad_2A.pdf" target="_blank"><button class="decouvrir">Télécharger le questionnaire</button></a></div>
							...
							<div class="partListe"><i id="sunIcon" class="fas fa-sun"></i>Si tu veux participer au WEI <a href="wei.php"><button class="decouvrir">Inscription au Wei</button></a></div>
						 </div>
