		...
		<!-- Two -->
			<article id="four" class="post invert style2 alt">
				...
				<div class="content">
					<div class="inner">
						<header>
							<h2>Mot du grand FilièreClassix</h2>
							<p class="info">Il se racla la gorge et lança d’un air d’autoroute : </a></p>
						</header>
						<p>
...
Tu y trouveras toutes sortes d’informations sur ton rite de passage d’irréductible étudiant à irréductible ingénieur, sur ta chaumière, sur la vie au village, sur la taverne et surtout sur L’ÉNORME, QUE DIS-JE PAR TOUTATIS , LA DIVINE INTÉGRATION que nous, les CDP’s (Chamois du Périgord ou Comité de Parrainage à toi de voir..) te préparons d’arrache-pied depuis 4 mois. <br>

</p>
						<ul class="actions">
							<li><a href="#three" class="scrolly button alt">La suite ?</a></li>
						</ul>
					</div>
					<div class="postnav">
...
Tes Marios à l’autre bout du tuyau.</p>
						<ul class="actions">
							<li><a href="mot.php" class="button alt">Le mot aux parents</a></li>
						</ul>
					</div>
					<div class="postnav">
